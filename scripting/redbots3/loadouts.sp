...
// ==============================================
// DEFENDERBOTS LOADOUTS
// ==============================================
public const int DEFENDER_SCOUT_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 200, 45, 220, 448, 669, 772, 799, 808, 888, 897, 906, 915, 964, 973, 1078, 1103, 15002, 15015, 15021, 15029, 15036, 15053, 15065, 15069, 15106, 15107, 15108, 15131, 15151, 15157};
public const int DEFENDER_SCOUT_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 209, 46, 160, 163, 222, 294, 449, 773, 812, 833, 1121, 1145, 15013, 15018, 15035, 15041, 15046, 15056, 15060, 15061, 15100, 15101, 15102, 15126, 15148, 30666};
public const int DEFENDER_SCOUT_MELEE[] = {TF_ITEMDEF_DEFAULT, 190, 44, 221, 264, 317, 325, 349, 355, 423, 450, 452, 474, 572, 648, 660, 880, 939, 954, 999, 1013, 1071, 1123, 1127, 1202, 30667, 30758};

public const int DEFENDER_SOLDIER_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 205, 127, 228, 414, 441, 513, 658, 730, 800, 809, 889, 898, 907, 916, 965, 974, 1085, 1104, 15006, 15014, 15028, 15043, 15052, 15057, 15081, 15104, 15105, 15129, 15130, 15150};
public const int DEFENDER_SOLDIER_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 199, 129, 133, 226, 354, 415, 442, 444, 1001, 1101, 1141, 1153, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int DEFENDER_SOLDIER_MELEE[] = {TF_ITEMDEF_DEFAULT, 196, 128, 154, 264, 357, 416, 423, 447, 474, 775, 880, 939, 954, 1013, 1071, 1123, 1127, 30758};

public const int DEFENDER_PYRO_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 208, 40, 215, 594, 659, 741, 798, 807, 887, 896, 905, 914, 963, 972, 1146, 1178, 15005, 15017, 15030, 15034, 15049, 15054, 15066, 15067, 15068, 15089, 15090, 15115, 15141, 30474};
public const int DEFENDER_PYRO_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 199, 39, 351, 415, 595, 740, 1081, 1141, 1153, 1179, 1180, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int DEFENDER_PYRO_MELEE[] = {TF_ITEMDEF_DEFAULT, 192, 38, 153, 214, 264, 326, 348, 423, 457, 466, 474, 593, 739, 813, 834, 880, 939, 954, 1000, 1013, 1071, 1123, 1127, 1181, 30758};

public const int DEFENDER_DEMOMAN_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 206, 308, 405, 608, 996, 1007, 1101, 1151, 15077, 15079, 15091, 15092, 15116, 15117, 15142, 15158};
public const int DEFENDER_DEMOMAN_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 207, 130, 131, 265, 406, 661, 797, 806, 886, 895, 904, 913, 962, 971, 1099, 1144, 1150, 15009, 15012, 15024, 15038, 15045, 15048, 15082, 15083, 15084, 15113, 15137, 15138, 15155};
public const int DEFENDER_DEMOMAN_MELEE[] = {TF_ITEMDEF_DEFAULT, 191, 132, 154, 172, 264, 266, 307, 327, 357, 404, 423, 474, 482, 609, 880, 939, 954, 1013, 1071, 1082, 1123, 1127, 30758};

public const int DEFENDER_HEAVY_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 202, 41, 298, 312, 424, 654, 793, 802, 811, 832, 850, 882, 891, 900, 909, 958, 967, 1206, 15004, 15020, 15026, 15031, 15040, 15055, 15086, 15087, 15088, 15098, 15099, 15123, 15124, 15125, 15147};
public const int DEFENDER_HEAVY_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 199, 425, 1141, 1153, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int DEFENDER_HEAVY_MELEE[] = {TF_ITEMDEF_DEFAULT, 195, 43, 239, 264, 310, 331, 423, 426, 474, 587, 656, 880, 939, 1013, 1071, 1084, 1100, 1123, 1127, 1184, 30758};

public const int DEFENDER_ENGINEER_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 199, 141, 527, 588, 997, 1004, 1141, 1153, 15003, 15016, 15044, 15047, 15085, 15109, 15132, 15133, 15152};
public const int DEFENDER_ENGINEER_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 209, 140, 160, 294, 528, 1086, 1202, 15013, 15018, 15035, 15041, 15046, 15056, 15060, 15061, 15100, 15101, 15102, 15126, 15148, 30666, 30668};
public const int DEFENDER_ENGINEER_MELEE[] = {TF_ITEMDEF_DEFAULT, 197, 142, 155, 169, 329, 423, 589, 662, 795, 804, 884, 893, 902, 911, 960, 969, 1071, 1123, 15073, 15074, 15075, 15139, 15140, 15114, 15156, 30758};

public const int DEFENDER_MEDIC_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 204, 36, 305, 412, 1079};
public const int DEFENDER_MEDIC_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 211, 35, 411, 663, 796, 805, 885, 894, 903, 912, 961, 970, 998, 15008, 15010, 15025, 15039, 15050, 15078, 15097, 15121, 15122, 15120, 15145, 15146};
public const int DEFENDER_MEDIC_MELEE[] = {TF_ITEMDEF_DEFAULT, 198, 37, 173, 264, 304, 413, 423, 474, 880, 939, 954, 1003, 1013, 1071, 1123, 1127, 1143, 30758};

public const int DEFENDER_SNIPER_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 201, 56, 230, 402, 526, 664, 752, 792, 801, 851, 881, 890, 899, 908, 957, 966, 1005, 1092, 1098, 15000, 15007, 15019, 15023, 15033, 15059, 15070, 15071, 15072, 15111, 15112, 15135, 15136, 15154, 30665};
public const int DEFENDER_SNIPER_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 203, 57, 58, 231, 642, 751, 1083, 1105, 1149, 15001, 15022, 15032, 15037, 15058, 15076, 15110, 15134, 15153};
public const int DEFENDER_SNIPER_MELEE[] = {TF_ITEMDEF_DEFAULT, 193, 171, 232, 264, 401, 423, 474, 880, 939, 954, 1013, 1071, 1123, 1127, 30758};

public const int DEFENDER_SPY_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 210, 61, 161, 224, 460, 525, 1006, 1142, 15011, 15027, 15042, 15051, 15062, 15063, 15064, 15103, 15128, 15127, 15149};
public const int DEFENDER_SPY_BUILDING[] = {TF_ITEMDEF_DEFAULT, 736, 810, 831, 933, 1080, 1102};
public const int DEFENDER_SPY_MELEE[] = {TF_ITEMDEF_DEFAULT, 194, 225, 356, 423, 461, 574, 638, 649, 665, 727, 794, 803, 883, 892, 901, 910, 959, 968, 1071, 15080, 15094, 15095, 15096, 15118, 15119, 15143, 15144, 30758};
public const int DEFENDER_SPY_PDA2[] = {TF_ITEMDEF_DEFAULT, 212, 59, 60, 297, 947, 1205};

// ==============================================
// BUYROBOT LOADOUTS
// ==============================================
public const int BUYROBOT_SCOUT_PRIMARY[] = {13, 45, 220, 448, 772};
public const int BUYROBOT_SCOUT_SECONDARY[] = {23, 46, 160, 163, 222, 294, 449, 773, 833, 1121};
public const int BUYROBOT_SCOUT_MELEE[] = {0, 44, 221, 317, 325, 349, 355, 450, 452, 572, 648};

public const int BUYROBOT_SOLDIER_PRIMARY[] = {18, 127, 228, 414, 441, 513, 730, 1104};
public const int BUYROBOT_SOLDIER_SECONDARY[] = {10, 129, 133, 226, 354, 415, 442, 444, 1153};
public const int BUYROBOT_SOLDIER_MELEE[] = {6, 128, 154, 357, 416, 447, 775};

public const int BUYROBOT_PYRO_PRIMARY[] = {21, 40, 215, 594, 741, 1178};
public const int BUYROBOT_PYRO_SECONDARY[] = {12, 39, 351, 415, 595, 740, 1153, 1180};
public const int BUYROBOT_PYRO_MELEE[] = {2, 38, 153, 214, 326, 348, 457, 466, 593, 739, 813, 834};

public const int BUYROBOT_DEMOMAN_PRIMARY[] = {19, 308, 405, 608};
public const int BUYROBOT_DEMOMAN_SECONDARY[] = {131, 406, 1099};
public const int BUYROBOT_DEMOMAN_MELEE[] = {132, 172, 266, 327, 404, 482};

public const int BUYROBOT_HEAVY_PRIMARY[] = {15, 41, 298, 312, 424, 811};
public const int BUYROBOT_HEAVY_SECONDARY[] = {11, 425, 1153};
public const int BUYROBOT_HEAVY_MELEE[] = {5, 43, 239, 310, 331, 426, 587, 1100};

public const int BUYROBOT_ENGINEER_PRIMARY[] = {9, 141, 527, 588, 997};
public const int BUYROBOT_ENGINEER_SECONDARY[] = {22, 140, 160, 528, 1153};
public const int BUYROBOT_ENGINEER_MELEE[] = {7, 155, 329};

public const int BUYROBOT_MEDIC_PRIMARY[] = {17, 36, 305, 412};
public const int BUYROBOT_MEDIC_SECONDARY[] = {29, 35, 411};
public const int BUYROBOT_MEDIC_MELEE[] = {8, 37, 173, 304, 413};

public const int BUYROBOT_SNIPER_PRIMARY[] = {14, 230, 402, 526, 851, 1098, 30665};
public const int BUYROBOT_SNIPER_SECONDARY[] = {16, 57, 58, 231, 642, 751, 1105};
public const int BUYROBOT_SNIPER_MELEE[] = {3, 171, 232, 401};

public const int BUYROBOT_SPY_SECONDARY[] = {24, 61, 161, 224, 460, 525};
public const int BUYROBOT_SPY_BUILDING[] = {735, 736, 810, 831, 933, 1102};
public const int BUYROBOT_SPY_MELEE[] = {4, 225, 356, 461, 574, 638, 649};
public const int BUYROBOT_SPY_PDA2[] = {30, 59, 60};
...
public Action Timer_GiveCustomLoadout(Handle timer, int client)
{
	...
	if (m_iWeaponPrimary[client] > TF_ITEMDEF_DEFAULT)
	{
		...
		if (TF2Econ_GetItemClassName(m_iWeaponPrimary[client], itemClassname, sizeof(itemClassname)))
		{
			...
			if (g_bHasBoughtUpgrades[client] == false)
			{
				...
				{
					case 730:	TF2Attrib_SetByName(primary, "auto fires when full", 1.0);
					case 996:	TF2Attrib_SetByName(primary, "grenade launcher mortar mode", 0.0);
				}
			}
		}
		else
    ...
    new ammoType;
    for (ammoType = TF_AMMO_PRIMARY; ammoType < TF_AMMO_COUNT; ammoType++)
    {
        int maxAmmo = TF2Util_GetPlayerMaxAmmo(client, ammoType);
        if (maxAmmo > 0)
            GivePlayerAmmo(client, maxAmmo, ammoType, true);
        else
            GivePlayerAmmo(client, 1000, ammoType, true);
    }
...
int GetRandomWeaponForClass(const char[] class, const char[] slot, int client = -1)
{
    bool isBuyRobot = (client > 0 && g_bBuyIsPurchasedRobot[client]);
    ...
    if (isBuyRobot)
    {
        ...
        else if (StrEqual(class, "spy", false))
        {
            if (StrEqual(slot, "primary", false))
                ...
                return BUYROBOT_SPY_BUILDING[GetRandomInt(0, sizeof(BUYROBOT_SPY_BUILDING) - 1)];
            else if (StrEqual(slot, "melee", false))
                return BUYROBOT_SPY_MELEE[GetRandomInt(0, sizeof(BUYROBOT_SPY_MELEE) - 1)];
            else if (StrEqual(slot, "pda2", false))
                return BUYROBOT_SPY_PDA2[GetRandomInt(0, sizeof(BUYROBOT_SPY_PDA2) - 1)];
        }
    }
    else
    {
        ...
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_SCOUT_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_SCOUT_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_SCOUT_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_SCOUT_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_SCOUT_MELEE[GetRandomInt(0, sizeof(DEFENDER_SCOUT_MELEE) - 1)];
        }
        else if (StrEqual(class, "soldier", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_SOLDIER_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_SOLDIER_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_SOLDIER_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_SOLDIER_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_SOLDIER_MELEE[GetRandomInt(0, sizeof(DEFENDER_SOLDIER_MELEE) - 1)];
        }
        else if (StrEqual(class, "pyro", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_PYRO_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_PYRO_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_PYRO_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_PYRO_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_PYRO_MELEE[GetRandomInt(0, sizeof(DEFENDER_PYRO_MELEE) - 1)];
        }
        else if (StrEqual(class, "demoman", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_DEMOMAN_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_DEMOMAN_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_DEMOMAN_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_DEMOMAN_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_DEMOMAN_MELEE[GetRandomInt(0, sizeof(DEFENDER_DEMOMAN_MELEE) - 1)];
        }
        else if (StrEqual(class, "heavyweapons", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_HEAVY_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_HEAVY_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_HEAVY_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_HEAVY_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_HEAVY_MELEE[GetRandomInt(0, sizeof(DEFENDER_HEAVY_MELEE) - 1)];
        }
        else if (StrEqual(class, "engineer", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_ENGINEER_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_ENGINEER_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_ENGINEER_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_ENGINEER_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_ENGINEER_MELEE[GetRandomInt(0, sizeof(DEFENDER_ENGINEER_MELEE) - 1)];
        }
        else if (StrEqual(class, "medic", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_MEDIC_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_MEDIC_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_MEDIC_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_MEDIC_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_MEDIC_MELEE[GetRandomInt(0, sizeof(DEFENDER_MEDIC_MELEE) - 1)];
        }
        else if (StrEqual(class, "sniper", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_SNIPER_PRIMARY[GetRandomInt(0, sizeof(DEFENDER_SNIPER_PRIMARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_SNIPER_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_SNIPER_SECONDARY) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_SNIPER_MELEE[GetRandomInt(0, sizeof(DEFENDER_SNIPER_MELEE) - 1)];
        }
        else if (StrEqual(class, "spy", false))
        {
            if (StrEqual(slot, "primary", false))
                return DEFENDER_SPY_SECONDARY[GetRandomInt(0, sizeof(DEFENDER_SPY_SECONDARY) - 1)];
            else if (StrEqual(slot, "secondary", false))
                return DEFENDER_SPY_BUILDING[GetRandomInt(0, sizeof(DEFENDER_SPY_BUILDING) - 1)];
            else if (StrEqual(slot, "melee", false))
                return DEFENDER_SPY_MELEE[GetRandomInt(0, sizeof(DEFENDER_SPY_MELEE) - 1)];
            else if (StrEqual(slot, "pda2", false))
                return DEFENDER_SPY_PDA2[GetRandomInt(0, sizeof(DEFENDER_SPY_PDA2) - 1)];
        }
    }
